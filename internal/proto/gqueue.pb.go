...
func (x *TaksMessage) Reset() {
	*x = TaksMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gqueue_proto_msgTypes[0]
...
func (*TaksMessage) Descriptor() ([]byte, []int) {
	return file_gqueue_proto_rawDescGZIP(), []int{0}
}
...
var File_gqueue_proto protoreflect.FileDescriptor

var file_gqueue_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x67, 0x71, 0x75, 0x65, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06,
	0x67, 0x71, 0x75, 0x65, 0x75, 0x65, 0x22, 0x87, 0x03, 0x0a, 0x0b, 0x54, 0x61, 0x6b, 0x73, 0x4d,
	...
	0x69, 0x61, 0x6e, 0x68, 0x6f, 0x6e, 0x67, 0x77, 0x75, 0x2f, 0x67, 0x71, 0x75, 0x65, 0x75, 0x65,
	0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_gqueue_proto_rawDescOnce sync.Once
	file_gqueue_proto_rawDescData = file_gqueue_proto_rawDesc
)

func file_gqueue_proto_rawDescGZIP() []byte {
	file_gqueue_proto_rawDescOnce.Do(func() {
		file_gqueue_proto_rawDescData = protoimpl.X.CompressGZIP(file_gqueue_proto_rawDescData)
	})
	return file_gqueue_proto_rawDescData
}

var file_gqueue_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_gqueue_proto_goTypes = []any{
	(*TaksMessage)(nil), // 0: gqueue.TaksMessage
}
var file_gqueue_proto_depIdxs = []int32{
...
func init() { file_gqueue_proto_init() }
func file_gqueue_proto_init() {
	if File_gqueue_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gqueue_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gqueue_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gqueue_proto_goTypes,
		DependencyIndexes: file_gqueue_proto_depIdxs,
		MessageInfos:      file_gqueue_proto_msgTypes,
	}.Build()
	File_gqueue_proto = out.File
	file_gqueue_proto_rawDesc = nil
	file_gqueue_proto_goTypes = nil
	file_gqueue_proto_depIdxs = nil
}
